# Generated by Powerlevel10k configuration wizard on 2026-06-11 at 21:07 CEST.
...
# blurred heads, blurred tails, 1 line, sparse, concise, transient_prompt,
...
() {
  ...
  function my_git_formatter() {
    ...
    # !N if have unstaged or untracked files (combined count).
    local num_dirty=$(( VCS_STATUS_NUM_UNSTAGED + VCS_STATUS_NUM_UNTRACKED ))
    (( num_dirty )) && res+=" ${modified}!${num_dirty}"
